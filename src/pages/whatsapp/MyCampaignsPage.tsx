...
const MyCampaignsPage = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setCampaigns([
        { id: '1', name: 'عرض خاص يناير - خاص بي', type: 'تسويق', messages: 850, status: 'مكتملة', date: '2026-01-15' },
        { id: '2', name: 'تذكير بالدفع - خاص بي', type: 'تذكير', messages: 420, status: 'قيد التنفيذ', date: '2026-01-25' },
      ]);
      setLoading(false);
    }, 800);
    ...
    <div className="container py-8 space-y-6" dir="rtl">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">عرض حملات الواتساب التي أنشأتها أنت فقط</p>
        </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <CardTitle>قائمة حملاتي</CardTitle>
